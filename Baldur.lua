SetPrivateProfileString('Graphics','renderer','Intel(R) Iris(R) Xe Graphics')
...
SetPrivateProfileString('Graphics','version','OpenGL version 4.6.0 - Build 32.0.101.5972 - build XXXX')
